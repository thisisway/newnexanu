...
export default function PortalSettingsPage() {
  ...
  return (
    <div className="flex flex-col gap-6 max-w-xl">
      <div>
        <h1 className="text-h2 font-bold text-foreground">Configurações</h1>
        <p className="mt-1 text-sm text-muted-foreground">Gerencie seus dados pessoais e segurança.</p>
      </div>
